...
public class MenuComponents {
    ...
    public static void incArticles(String party){
        if (party.equals("Fascist")) fascistArticles++;
        else liberalArticles++;
    }

    public static void setBoard(){
        fascistBoard.setIcon(fascistBoardImage5to6_1article);
        // HERE YOU CAN IMPLEMENT THE CHANGING OF THE BOARD, BASED UPON THE NUMBER OF ARTICLES
        // liberalArticles = number of articles on liberal board
        // fascistArticles = number of articles on fascist board
    }
